#ifndef resourceoverflow
#define resourceoverflow
...
void bag_total_input_function(int &bag_total_resource, int &input_item, int &input_amount, string &confirm_button, int &function_count)
{
  if (function_count == 0)
  {
  ...
  //cin >> input_amount;
  while (!(cin >> input_amount))
  { //have to deal with inputing double as well
...
void bag_total_function(int &bag_total_resource, int &input_item, int &input_amount, string &confirm_button, int &function_count)
{
  while (maximum < 0)
  {
    ...
    bag_total_input_function(bag_total_resource, input_item, input_amount, confirm_button, function_count);
...
void single_item_function(int &bag_total_resource, int &input_amount, string &confirm_button)
{
  for (int i = 0; i < resource_vector_size; i++)
  {
...
void resource_overflow()
{
  ...
  for (int i = 0; i < resource_vector_size; i++)
  {
    maximum -= resource_amount[i];
  }

  single_item_function(bag_total_resource, input_amount, confirm_button);
  bag_total_function(bag_total_resource, input_item, input_amount, confirm_button, function_count);
  print_resource();
  //--------separate line------------//
  return;
}
