...
void lawn(int &brutal_count, vector<int> &resource_amount, int resource_vector_size, int &sentiment_count){
  ...
  //max;
  int count = 1, lawn_sentiment_count = 0;
  char choice;
  for (int k = 0; k < 3; k++){
    if (count == 1){
...
int main(){
  ...
  lawn(brutal_count, resource_amount, resource_vector_size, sentiment_count);
}
